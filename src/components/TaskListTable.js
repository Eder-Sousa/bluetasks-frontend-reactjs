...
export const TaskListTable = () => {
    ...
    useEffect(() => {
        ...
        if (tasks.taskUpdated !== null) {
            toast.success(`Tarefa ${tasks.taskUpdated.id} foi marcada como 
                ${!tasks.taskUpdated.done ? "não" : ""} concluída!`,
                { position: toast.POSITION.BOTTOM_LEFT });
                ...
                <table className="table table-striped">
                    ...
                    <tbody>
                        {tasks.taskList.length === 0 ?
                            <tr><td colSpan="4">Sem taferas cadastradas no momento!</td></tr>
                            :
